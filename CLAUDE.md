...
**Branch:** `feature/mainworld-physical-detail` · **Main:** `main`  
**Virtual environment:** `.venv-1` (Python 3.11, includes PySide6)
...
| `traveller_system_gen.py`, `traveller_world_gen.py`, or `traveller_world_physical.py` | [`context/system-world.md`](context/system-world.md) + [`context/data-structures.md`](context/data-structures.md) + [`context/generation-pipeline.md`](context/generation-pipeline.md) |
...
- **Pylint:** `.venv-1/bin/pylint <file>` — target **10.00/10 per file**
- **Tests:** `.venv-1/bin/pytest tests/ -q` — **890 tests**, all must pass
...
4. Do **not** delete compliance audit entries.  
